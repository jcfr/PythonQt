...
QHash<int, PythonQtConvertMetaTypeToPythonCB*>& PythonQtConv::GetMetaTypeToPythonConverters() {
  static QHash<int, PythonQtConvertMetaTypeToPythonCB*> metaTypeToPythonConverters;
  return metaTypeToPythonConverters;
}

QHash<int, PythonQtConvertPythonToMetaTypeCB*>& PythonQtConv::GetPythonToMetaTypeConverters() {
  static QHash<int, PythonQtConvertPythonToMetaTypeCB*> pythonToMetaTypeConverters;
  return pythonToMetaTypeConverters;
}
